...
def season(htmlstring19):
    soup = BeautifulSoup(htmlstring19, 'html.parser')
    teams_list = []
    wins_quality = []
    draw_quality = []
    lose_quality = []
    ...
    for tr_tag in tr_tags:
        ...
        if len(td_tags) > 1:
            ...
            team_name_tag = td_tags[1].find("b")
            if team_name_tag:
    ...
    #     sql = """INSERT INTO season2004_2005 (TeamName, Wins, Draws, Loses, Goals, Conceded, Points)
