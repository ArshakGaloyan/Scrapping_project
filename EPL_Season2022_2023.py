...
def season(htmlstring1):
    soup = BeautifulSoup(htmlstring1, 'html.parser')
    teams_list = []
    wins_quality = []
    draw_quality = []
    lose_quality = []
    ...
    # Print the translated team names and their win counts
    print(teams_list)
    wins_quality.pop(0)
    ...
    # Cursor.execute(TableName, multi=True)
    # cnx.commit()
    ...
    #     sql = """INSERT INTO season2022_2023 (TeamName, Wins, Draws, Loses, Goals, Conceded, Points)
